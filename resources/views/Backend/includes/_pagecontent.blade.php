            ...
            <div class="card radius-10 w-100">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-transparent">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Backend/images/avatars/avatar-1.png')}}" alt="user avatar" class="rounded-circle" width="55" height="55">
                            <div class="ms-3">
                    ...
                    <li class="list-group-item bg-transparent">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Backend/images/avatars/avatar-2.png')}}" alt="user avatar" class="rounded-circle" width="55" height="55">
                            <div class="ms-3">
                    ...
                    <li class="list-group-item bg-transparent">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Backend/images/avatars/avatar-3.png')}}" alt="user avatar" class="rounded-circle" width="55" height="55">
                            <div class="ms-3">
                    ...
                    <li class="list-group-item bg-transparent">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Backend/images/avatars/avatar-4.png')}}" alt="user avatar" class="rounded-circle" width="55" height="55">
                            <div class="ms-3">
                    ...
                    <li class="list-group-item bg-transparent">
                        <div class="d-flex align-items-center">
                            <img src="{{asset('Backend/images/avatars/avatar-7.png')}}" alt="user avatar" class="rounded-circle" width="55" height="55">
                            <div class="ms-3">
