@extends('Backend.Admin.masteradmin')
@section('maincontent')
                    ...
                    <div class="product-list p-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/chair.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/user-interface.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/watch.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/idea.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/tshirt.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 mb-3 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/headphones.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                        ...
                        <div class="row border mx-0 py-2 radius-10 cursor-pointer">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <div class="product-img">
                                        <img src="{{asset('Backend/images/icons/shoes.png')}}" alt="" />
                                    </div>
                                    <div class="ms-2">
                            ...
                            <table class="table align-middle mb-0 table-hover" id="Transaction-History">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-1.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-2.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-3.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-4.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-7.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-8.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-9.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-10.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-11.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-12.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                                <h6 class="mb-1 font-14">Payment from Lewis Cruz</h6>
                                                <p class="mb-0 font-13 text-secondary">Refrence Id #8576420</p>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-13.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
                                                <h6 class="mb-1 font-14">Payment from David Buckley</h6>
                                                <p class="mb-0 font-13 text-secondary">Refrence Id #8576420</p>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <img src="{{asset('Backend/images/avatars/avatar-14.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                                            </div>
                                            <div class="ms-2">
            ...
            <div class="col-12 col-xl-6 d-flex">
                <div class="card radius-10 w-100">
                    ...
                    <div class="customers-list p-3 mb-3">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-23.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-24.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-20.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-16.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-25.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
                        ...
                        <div class="customers-list-item d-flex align-items-center border-bottom p-2 cursor-pointer">
                            <div class="">
                                <img src="{{asset('Backend/images/avatars/avatar-17.png')}}" class="rounded-circle" width="46" height="46" alt="" />
                            </div>
                            <div class="ms-2">
